...
Start PixInsight and launch the AnnotateImage script.
...
In the "Label Text" group you can select what text should be displayed next to the circles: Name, Coordinates or Magnitude and, by choosing the appropriate dropbox, where will the text be relative to the circles.
